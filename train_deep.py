...
def train_deep_model():
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(dataset)):
        ...
        for epoch in range(EPOCH):
            ...
            if val_loss < best_val_loss:
                ...
                }, f'result/best_model_deep_fold_{fold+1}.pth')
        ...
        torch.save({
            ...
            'epoch': EPOCH - 1,
            'best_val_loss': best_val_loss
        }, f'result/final_model_deep_fold_{fold+1}.pth')
        ...
        np.save(f'result/loss_history_deep_fold_{fold+1}.npy', loss_history)
        
        # 绘制并保存损失曲线
        plot_training_validation_loss(
            train_losses, 
            val_losses, 
            f'result/loss_curve_deep_fold_{fold+1}.png',
            f'第 {fold+1} 折深度学习模型训练和验证损失曲线'
        )
    ...
    np.save('result/deep_overall_results.npy', overall_results)
