...
from model import FloodPredictionModelWithResidual, FloodPredictionModel
...
def train_model_with_kfold(device, full_dataset):
    # 初始化KFold
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(full_dataset)):
        ...
        # 注意：某些版本的PyTorch在MPS上可能存在ReduceLROnPlateau的兼容性问题
        ...
        for epoch in range(EPOCH):
            ...
            if val_loss < best_val_loss:
                ...
                # 保存模型到result目录
                torch.save(net.state_dict(), f'result/best_model_fold_{fold + 1}.pth')
...
if __name__ == '__main__':
    ...
    # 执行K折交叉验证
    fold_results = train_model_with_kfold(device, full_dataset)
